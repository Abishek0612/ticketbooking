...
export default function Header({onClick, children}) {
                    ...
                    >
                        <li>
                            <button className='dark:bg-white bg-dark-subtle p-1 rounded' >
                                <BsFillSunFill onClick={onClick} size={24} />{children}
                            </button>
                        </li>
                    </IconButton>
            ...
            <Modal open={open} onClose={handleClose} >
                <Box sx={{
                    ...
                    <Typography sx={{ mt: 2 }}>
                        ...
                        <a href='https://igotucovereddotcom.netlify.app' target="_blank" rel="noreferrer"  >IGotYouCovered.com</a>
                    </Typography>
                </Box>
            </Modal>
        </Box>
